...
int main() {
    ...
    hittable_list world;
    world.add(std::make_shared<sphere>(point3( 0.0, -100.5, -1.0), 100.0, ground_mat));  
    world.add(std::make_shared<sphere>(point3( 0.0,  0.0, -1.0),   0.5,  center_mat));   
    world.add(std::make_shared<sphere>(point3(-1.0,  0.0, -1.0),   0.5,  glass_mat));    
    world.add(std::make_shared<sphere>(point3(-1.0,  0.0, -1.0),  -0.45, glass_mat));    
    world.add(std::make_shared<sphere>(point3( 1.0,  0.0, -1.0),   0.5,  metal_mat));    
